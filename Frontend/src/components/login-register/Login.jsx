                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <namem className="space-y-4 md:space-y-6" action="#">
                                <form  className="space-y-4 md:space-y-6" >
                                    ...
                                    <button type="submit" className="mt-5 w-full text-white bg-[#FF630E] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign in</button>
                                </form>
                                <div className="text-center"><button className="flex items-center text-center gap-5 w-full text-white border-[#FF630E] border-2 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 "><FcGoogle className="ml-8 lg:ml-20 text-2xl"></FcGoogle>Sign in with Google</button></div>
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Dont have an account yet? <Link to='/register'><a href="#" className="font-medium text-[#FF630E] hover:underline dark:text-primary-500">Sign up</a></Link>
                                </p>
                            </namem>
                        </div>
                    </div>
