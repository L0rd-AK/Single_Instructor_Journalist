                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <namem className="space-y-4 md:space-y-6" action="#">
                                <form className="space-y-4 md:space-y-6" onSubmit={handleRegister}>
                                    ...
                                    <button type="submit" className="w-full text-white bg-[#FF630E] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create an account</button>
                                    <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                        Already have an account? <Link to='/login'><a href="#" className="font-medium text-[#FF630E] hover:underline dark:text-primary-500">Login here</a></Link>
                                    </p>
                                </form>
                            </namem>
                        </div>
